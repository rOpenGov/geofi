...
#' @param crs string CRS of the output sf object. One of 'EPSG:3067' or 'EPSG:4326'
...
geocode2 <- function(search_string,
  ...
  query_geocode <- function(x, query_ua = ua, crs1=crs){
...
#' \url{https://www.maanmittauslaitos.fi/kartat-ja-paikkatieto/ammattilaiskayttajille/paikkatietojen-rajapintapalvelut/geokoodauspalvelu}
...
#'             source = "geographic-names")
geocode_reverse2 <- function(point,
