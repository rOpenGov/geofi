#' Get geospatial data from a WFS
#'
#' `get_wfs_layer()` retrieves geospatial data from a WFS source and turns the
#' retrieved data into a `sf` object.
#'
...
#'  version <- "1.0.0"
#'  sp_dat <- get_wfs_layer(url, layer, version)
#'  }
#'
#' @rdname get_wfs_layer
#' @export
#'
