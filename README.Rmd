...
[![Codecov test coverage](https://codecov.io/gh/rOpenGov/geofi/branch/master/graph/badge.svg)](https://codecov.io/gh/rOpenGov/geofi?branch=master)
...
**Kindly cite this work** as follows: Markus Kainu, Joona Lehtomäki, and Leo Lahti. Retrieval and analysis of open geospatial data from Finland with the geofi R package. R package version `r sessionInfo()$otherPkgs$geofi$Version`. URL: [http://ropengov.github.io/geofi](http://ropengov.github.io/geofi)
