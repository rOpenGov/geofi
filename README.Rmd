...
**Kindly cite this work** as follows: Markus Kainu, Joona Lehtomäki, and Leo Lahti. Retrieval and analysis of open geospatial data from Finland with the gisfin R package. R package version `r sessionInfo()$otherPkgs$gisfin$Version`. URL: [http://ropengov.github.io/gisfin](http://ropengov.github.io/gisfin)
