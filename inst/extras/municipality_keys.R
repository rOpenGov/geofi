...
mutate(hyvinvointialue_name_fi = case_when(
  ...
  mutate(hyvinvointialue_name_en = case_when(
    maakunta_name_fi == "Varsinais-Suomi" ~ "Wellbeing services country of Southwest Finland",
    maakunta_name_fi == "Satakunta" ~ "Wellbeing services country of Satakunta",
    maakunta_name_fi == "Kanta-Häme" ~ "Wellbeing services country of Kanta-Häme",
    maakunta_name_fi == "Pirkanmaa" ~ "Wellbeing services country of Pirkanmaa",
    maakunta_name_fi == "Päijät-Häme" ~ "Wellbeing services country of Päijät-Häme",
    maakunta_name_fi == "Kymenlaakso" ~ "Wellbeing services country of Kymenlaakso",
    maakunta_name_fi == "Etelä-Karjala" ~ "Wellbeing services country of South Karelia",
    maakunta_name_fi == "Etelä-Savo" ~ "Wellbeing services country of South Savo",
    maakunta_name_fi == "Pohjois-Savo" ~ "Wellbeing services country of North Savo",
    maakunta_name_fi == "Pohjois-Karjala" ~ "Wellbeing services country of North Karelia",
    maakunta_name_fi == "Keski-Suomi" ~ "Wellbeing services country of Central Finland",
    maakunta_name_fi == "Etelä-Pohjanmaa" ~ "Wellbeing services country of South Ostrobothnia",
    maakunta_name_fi == "Pohjanmaa" ~ "Wellbeing services country of Ostrobothnia",
    maakunta_name_fi == "Keski-Pohjanmaa" ~ "Wellbeing services country of Central Ostrobothnia",
    maakunta_name_fi == "Pohjois-Pohjanmaa" ~ "Wellbeing services country of North Ostrobothnia",
    maakunta_name_fi == "Kainuu" ~ "Wellbeing services country of Kainuu",
    maakunta_name_fi == "Lappi" ~ "Wellbeing services country of Lapland",
    municipality_name_fi %in% c("Askola","Lapinjärvi","Loviisa","Myrskylä","Porvoo","Pukkila","Sipoo") ~ "Wellbeing services country of East Uusimaa",
    municipality_name_fi %in% c("Hyvinkää","Järvenpää","Nurmijärvi","Mäntsälä","Tuusula","Pornainen") ~ "Wellbeing services country of Central Uusimaa",
    municipality_name_fi %in% c("Espoo","Hanko","Inkoo","Karkkila","Kauniainen","Kirkkonummi","Lohja","Raasepori","Siuntio","Vihti") ~ "Wellbeing services country of West Uusimaa",
    municipality_name_fi %in% c("Vantaa","Kerava") ~ "Wellbeing services country of Vantaa and Kerava",
    municipality_name_fi %in% c("Helsinki") ~ "City of Helsinki",
    maakunta_name_fi == "Ahvenanmaa" ~ "Wellbeing services country of Ålands"
  )) %>%
