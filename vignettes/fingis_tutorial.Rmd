...
### Helsinki region aluejakokartat (district maps)
...
### Spatial data from Maanmittauslaitos (MML, Land Survey Finland)

These data are preprocessde into RData format (FIXME: add description)
