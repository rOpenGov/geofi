...
get_municipality_pop(year = 2020) |> subset(select = miehet_p) |> plot()
```
...
get_municipality_pop(year = 2020) |> dplyr::group_by(hyvinvointialue_name_fi) |> summarise(vaesto = sum(vaesto)) |> subset(select = vaesto) |> plot()
```
