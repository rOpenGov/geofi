...
The following operations derive from [Marko Kallio's](https://markokallio.fi/) course at [CSC](https://csc.fi/en/) in February 2020 [Spatial data analysis with R](https://github.com/csc-training/r-spatial-course). 
