...
# Use tempdir() instead, should work on all platforms
# x$save("~/tmp/population1.grd")
x$save(file.path(tempdir(), "population1.grd"))
```
...
x$load(file.path(tempdir(), "population1.grd"))
...
NOTE! This example will be moved to a new weather data package soon!
